...
VERSION = __import__('dxlirflowclient').get_version()
RELEASE_NAME = "dxlirflowclient-python-dist-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlirflowclient")])
...
print("\nRemoving dxlirflowclient.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlirflowclient.egg-info"))
